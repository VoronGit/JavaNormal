...
public class MoveMeWithArrows {
    public static void main(String[] args) {
        new MainFrame("MoveMeWithArrows",900,900, new Field());
    }
}
        ...
        addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                ...
                if (KeyEvent.VK_RIGHT == key) {
                    xCor += 50;
                    if (xCor + img.getWidth()/2 > getWidth()/2) xCor = getWidth()/2 - img.getWidth()/2;
                } else if (KeyEvent.VK_LEFT == key) {
                    xCor -= 50;
                    if (-xCor + img.getWidth()/2 > getWidth()/2) xCor = - getWidth()/2 + img.getWidth()/2;
                } else if (KeyEvent.VK_DOWN == key) {
                    yCor += 50;
                    if (yCor + img.getHeight()/2 > getHeight()/2) yCor = getHeight()/2 - img.getHeight()/2;
